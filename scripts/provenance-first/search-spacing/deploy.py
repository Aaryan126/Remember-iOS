#!/usr/bin/env python3
"""Spacing update with isolated signed products and verified phone backups."""
import importlib.util
from pathlib import Path
import sys

CODE = Path(__file__).resolve().parent
spec = importlib.util.spec_from_file_location("spacing_checks", CODE / "check.py")
...
deployment.WORK = checks.ROOT / "Evaluation/ProvenanceFirst/search-spacing-deployment"
deployment.RUN = checks.ROOT / "Evaluation/ProvenanceFirst/runs/search-spacing-deployment"
