#!/usr/bin/env python3
"""Compact search header checks, preserving the installed spacing checkpoint."""
...
checks.CODE = CODE
checks.RUN = checks.ROOT / "Evaluation/ProvenanceFirst/runs/search-compact"
checks.WORK = checks.ROOT / "Evaluation/ProvenanceFirst/search-compact"
