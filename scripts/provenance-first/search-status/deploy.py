#!/usr/bin/env python3
"""Authorized search-status installation with existing preservation safeguards."""
...
spec = importlib.util.spec_from_file_location("status_install_checks", CODE / "check.py")
...
deployment.RUN = checks.ROOT / "Evaluation/ProvenanceFirst/runs/search-status-device"
...
if __name__ == "__main__":
    ...
    if action == "build":
        ...
        deployment.d.write(checks.WORK / "ready-to-install.json", {
            ...
            "sourceBoundChecks": {
                "ui": verified_suite("RememberUITests/UnifiedMemorySearchUITests", 15),
                "unit": verified_suite("RememberTests/UnifiedMemorySearchTests", 28)}})
